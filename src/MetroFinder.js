...
const MetroFinder = () => {
 ...
 >       
        ...
        >
          <h2 style={{ color: "#00ffe0", margin: 0 }}>Shortest Route</h2>
  ...
  <div> {/* You should not place <div> directly inside <tr>; use <td> instead */}
    <div className="right">
      <div
        style={{
          width: "500px",
     ...
     //border: "1px  1px   solid #00ffe0",  // Optional: just to visualize the box
         // boxShadow: "0px 0px 5px #00ffe0",
      ...
      >
        <img
          ...
          style={{
            width: "100%",   // Or set a fixed size like "50px"
            height: "auto",  // Maintain aspect ratio
            maxHeight: "500px" ,
            padding: "10px 20px",
            margin:"50px 220px",// Optional: constrain height
          }}
        />
      </div>
    </div>
